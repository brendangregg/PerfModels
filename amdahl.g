...
inputN = 12			# rows to include as model input
scale = 1.5			# scale graph beyond data points
set grid

set xlabel "CPUs (N)"
set ylabel "Throughput"
set title "Amdahl Scalability"
...
plot filename using 1:2 with points pt 6 lc rgb "#f00000" title "extra measurements",\
	filename every ::1::inputN using 1:2 with points pt 6 lc rgb "#000000" title "input for Amdahl"
...
# plot curves
replot amdahl(x) with line lc rgb "#000000" title "Amdahl(N)"
